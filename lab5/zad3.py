...
def createSphere(xs,ys,zs):
    # Przesunięcie obiektu do punktu (xs, ys, zs)- prezka
    glTranslatef(xs, ys, zs)

    # Rysowanie obiektu (sfera zbudowana z linii)- prezka
    quadric = gluNewQuadric()
    gluQuadricDrawStyle(quadric, GLU_LINE)
    gluSphere(quadric, 0.5, 6, 5)
    gluDeleteQuadric(quadric)

    # Odwrócenie transformacji- prezka
    glTranslatef(-xs, -ys, -zs)
...
def render(time):
    ...
    #ROBIMY ŚWIATŁO TAM GDZIE SFERA
